...
class TestFormatPrice(unittest.TestCase):
    ...
    def test_format_price(self):
        ...
        self.assertEqual(format_price('-543433.52355'), 'Negative price!')
    ...
    def test_valueError(self):
        self.assertEqual(format_price('price: 12312.3242'), 'Incorrect value!')

    def test_typeError(self):
        self.assertEqual(format_price(None), 'Incorrect type!')
